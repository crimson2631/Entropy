...
namespace Bose.Wearable
{
	public static class WearableConstants
	{
		...
		public static readonly GestureData EMPTY_GESTURE_DATA;
		...
		public const float DEVICE_USB_DYNAMIC_INFO_UPDATE_INTERVAL_IN_SECONDS = 0.125f;
		...
		public const string DEBUG_PROVIDER_ANR_INFO_REQUESTED =
			"[Bose Wearable] Debug provider received a request for active noise reduction information.";
		public const string DEBUG_PROVIDER_CNC_INFO_REQUESTED =
