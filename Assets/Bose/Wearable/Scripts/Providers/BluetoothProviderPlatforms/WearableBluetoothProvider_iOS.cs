...
namespace Bose.Wearable
{
	internal sealed partial class WearableBluetoothProvider : IWearableBluetoothProviderPlatform
	{
		...
		{
			WearableSetLoggingEnabled(logLevel != LogLevel.Release);
		}
		...
		private static unsafe Device CreateDevice(BridgeDevice bridgeDevice)
		{
			return new Device
			{
				...
				isConnected = bridgeDevice.isConnected,
		...
		/// </summary>
		[DllImport("__Internal")]
		private static extern void WearableSetLoggingEnabled(bool debug);
