...
namespace Bose.Wearable.Editor
{
	public static class BuildTools
	{
		...
		private const string WEARABLE_DEMO_ICON_GUID = "e06b243adbc49564b8ba586a2a0ed2d0";
		private const string BOSE_LOGO_ICON_GUID = "ca23c79dbd8ec42fb98cc414eb988fa8";
		...
		private static readonly string[] WEARABLE_DEMO_SCENE_GUIDS =
		{
			ROOT_SCENE_GUID,
